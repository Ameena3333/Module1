...
public class Fgp extends AppCompatActivity {
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(this, new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Fgp.this, "RESENT EMAIL SENT", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Fgp.this, "ENTER VALID EMAIL", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
